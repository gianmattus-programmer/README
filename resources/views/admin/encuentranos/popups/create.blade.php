    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-transparent p-4">
                <h5 class="modal-title">Crear popups</h5>
            ...
            <div class="modal-body bg-white p-4">
                <div class="row g-3 pt-3 pb-2 col-md-12">
                    ...
                    <div class="form-group mb-2 mt-2 col-md-12">
                        <label class="mb-2">Enlace</label>
                        <input class="form-control form-control-solid" id="enlace" name="enlace" type="text" required />
                    </div>
                    ...
                    <input class="form-control form-control-solid" id="encuentranos_id" name="encuentranos_id" type="hidden" value="1" />
                </div>
            </div>
