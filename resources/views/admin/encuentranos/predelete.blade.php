<div class="modal fade ModalPreDelete" id="ModalPreDelete{{ $temario->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-transparent pt-3 pb-2 p-4">
                <h5 class="modal-title">Eliminar temario</h5>
