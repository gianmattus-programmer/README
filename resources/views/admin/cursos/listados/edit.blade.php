<div class="modal fade" id="ModalEdit{{ $listado->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-black p-4">
                <h5 class="modal-title text-white">EDITAR CURSO {{ $listado->nombre }}</h5>
                    ...
                    <div class="form-group mb-2 mt-2 col-md-8">
                        <div class="row">
                            ...
                            <div class="form-group mb-2 mt-2 col-md-6">
                                ...
                                <input class="form-control form-control-solid" id="portada" name="portada" type="file" />
                            </div>

                            <div class="form-group mb-2 mt-2 col-md-6">
                                <label class="mb-2">Link de video</label>
                                <input class="form-control form-control-solid" id="video" name="video" type="text" required value="{{ $listado->video }}" />
                            </div>

                            <div class="form-group mb-2 mt-2 col-md-3">
                                <label class="mb-2">Meses</label>
                                <input class="form-control form-control-solid" id="meses" name="meses" type="text" required value="{{ $listado->meses }}" />
                            </div>

                            <div class="form-group mb-2 mt-2 col-md-3">
                                <label class="mb-2">Sesiones</label>
                                <input class="form-control form-control-solid" id="sesiones" name="sesiones" type="text" required value="{{ $listado->sesiones }}" />
                            </div>

                            <div class="form-group mb-2 mt-2 col-md-12">
                                <label class="mb-2">Descripción</label>
                                <textarea class="form-control form-control-solid" name="descripcion" id="descripcion" rows="3" placeholder="descripcion">{{ $listado->descripcion }}</textarea>
                            </div>
                        </div>
                    </div>
