...
class UsersManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        return View('usersmanagement.show-users', compact('users', 'roles', 'tlistados', 'tcategorias'));
    }
    ...
    public function create()
    {
        ...
        return view('usersmanagement.create-user', compact('roles', 'tlistados', 'tcategorias'));
    }
